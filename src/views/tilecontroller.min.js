...
///
PivotViewer.Views.TileController=Object.subClass({init:function(t){this._tiles=[],this._tilesById=[],this._easing=new Easing.Easer({type:"circular",side:"both"}),this._imageController=t
var i=this
this._tiles.push=function(t){this.__proto__.push.apply(i._tiles,[t]),i._tilesById[t.item.id]=t}},getTileById:function(t){var i=this._tilesById[t]
return void 0==i?null:i},initTiles:function(t,i,s){for(var e=0;e<t.length;e++){var h=new PivotViewer.Views.Tile(this._imageController)
h.item=t[e],this._canvasContext=s,h.context=this._canvasContext,tileLocation=new PivotViewer.Views.TileLocation,h._locations.push(tileLocation),this._tiles.push(h)}return this._tiles},animateTiles:function(){var t=this
this._started=!0
var i=null
if(this._tiles.length>0&&null!=this._tiles[0].context){i=this._tiles[0].context
for(var s=!1,e=0;e<this._tiles.length;e++)for(o=0;o<this._tiles[e]._locations.length;o++){var h=PivotViewer.Utils.now()-this._tiles[e].start,n=this._tiles[e].end-this._tiles[e].start
h<=n?(this._tiles[e]._locations[o].x==this._tiles[e]._locations[o].destinationx&&this._tiles[e]._locations[o].y==this._tiles[e]._locations[o].destinationy||(s=!0),this._tiles[e]._locations[o].x=this._easing.ease(h,this._tiles[e]._locations[o].startx,this._tiles[e]._locations[o].destinationx-this._tiles[e]._locations[o].startx,n),this._tiles[e]._locations[o].y=this._easing.ease(h,this._tiles[e]._locations[o].starty,this._tiles[e]._locations[o].destinationy-this._tiles[e]._locations[o].starty,n),this._tiles[e].width==this._tiles[e].destinationWidth&&this._tiles[e].height==this._tiles[e].destinationHeight||(s=!0),this._tiles[e].width=this._easing.ease(h,this._tiles[e].startwidth,this._tiles[e].destinationwidth-this._tiles[e].startwidth,n),this._tiles[e].height=this._easing.ease(h,this._tiles[e].startheight,this._tiles[e].destinationheight-this._tiles[e].startheight,n)):(this._tiles[e]._locations[o].x=this._tiles[e]._locations[o].destinationx,this._tiles[e]._locations[o].y=this._tiles[e]._locations[o].destinationy,this._tiles[e].width=this._tiles[e].destinationwidth,this._tiles[e].height=this._tiles[e].destinationheight),this._tiles[e]._locations[o].destinationx+this._tiles[e].destinationwidth<0||this._tiles[e]._locations[o].destinationx>i.canvas.width||this._tiles[e]._locations[o].destinationy+this._tiles[e].destinationheight<0||this._tiles[e]._locations[o].destinationy>i.canvas.height?this._tiles[e].destinationVisible=!1:this._tiles[e].destinationVisible=!0}}this._isZooming!=s&&(this._isZooming=s,$.publish("/PivotViewer/ImageController/Zoom",[this._isZooming])),i.clearRect(0,0,i.canvas.width,i.canvas.height)
for(var e=0;e<this._tiles.length;e++)for(var o=0;o<this._tiles[e]._locations.length;o++)this._tiles[e]._locations[o].x+this._tiles[e].width>0&&this._tiles[e]._locations[o].x<i.canvas.width&&this._tiles[e]._locations[o].y+this._tiles[e].height>0&&this._tiles[e]._locations[o].y<i.canvas.height&&this._tiles[e].draw(o)
this._breaks?this._started=!1:requestAnimFrame(function(){t.animateTiles()})},beginAnimation:function(){!this._started&&this._tiles.length>0&&(this._breaks=!1,this.animateTiles())},stopAnimation:function(){this._breaks=!0},setLinearEasingBoth:function(){this._easing=new Easing.Easer({type:"linear",side:"both"})},setCircularEasingBoth:function(){this._easing=new Easing.Easer({type:"circular",side:"both"})},setQuarticEasingOut:function(){this._easing=new Easing.Easer({type:"quartic",side:"out"})},getMaxTileRatio:function(){return this._imageController.MaxRatio}}),PivotViewer.Views.Tile=Object.subClass({init:function(t){return this instanceof PivotViewer.Views.Tile?(this._imageLoaded=!1,this._selected=!1,this._images=null,this._locations=[],void(this._visible=!0)):new PivotViewer.Views.Tile(t)},draw:function(t){var i=TileController._imageController
if(this.destinationVisible&&(this._images=i.getImages(this.item.img,this.width,this.height)),null!=this._images){if("function"==typeof this._images)this._images(this.item,this.context,this._locations[t].x+4,this._locations[t].y+4,this.width-8,this.height-8)
else if(this._images.length>0&&this._images[0]instanceof Image){var s=i.getHeight(this.item.img),e=i.getWidth(this.item.img),h=this.height-Math.ceil(this.height<128?this.height/16:8),n=this.width-Math.ceil(this.width<128?this.width/16:8)
blankWidth=this.width-8-n,blankHeight=this.height-8-h
var o=0,a=0,l=n,_=h
if(i instanceof PivotViewer.Views.DeepZoomImageController){var r=i._tileSize
y=this._images[0].src.match(/_files\/[0-9]+\//g)
var c=parseInt(y[0].substring(7,y[0].length-1)),g=1<<i.getMaxLevel(this.item.img)-c,d=Math.ceil(s/g),w=Math.ceil(e/g),m=h/d,u=n/w,x=m<u?m:u
l=w*x,_=d*x,o=Math.floor((n-l)/2),a=Math.floor((h-_)/2),overlap=i.getOverlap(this.item.img)
for(var v=0;v<this._images.length;v++){var f=this._images[v].src,y=f.match(/[0-9]+_[0-9]+/g),b=parseInt(y[y.length-1].substring(0,y[y.length-1].indexOf("_"))),p=parseInt(y[y.length-1].substring(y[y.length-1].indexOf("_")+1)),V=Math.ceil(this._images[v].height*x),C=Math.ceil(this._images[v].width*x),T=o+4+b*Math.floor((r-overlap)*x),E=a+4+Math.floor(p*(r-overlap)*x)
this.context.drawImage(this._images[v],T+this._locations[t].x,E+this._locations[t].y,C,V)}}else{var T=Math.floor(blankWidth/2)+4,E=4
this.context.drawImage(this._images[0],T+this._locations[t].x,E+this._locations[t].y,n,h)}if(this._selected){this.context.beginPath()
var T=o+4,E=a+4
this.context.rect(T+this._locations[this.selectedLoc].x,E+this._locations[this.selectedLoc].y,l,_),this.context.lineWidth=4,this.context.strokeStyle="#92C4E1",this.context.stroke()}}}else this.drawEmpty(t)},contains:function(t,s){for(i=0;i<this._locations.length;i++)if(this._locations[i].x<=t&&this._locations[i].x+this.width>=t&&this._locations[i].y<=s&&this._locations[i].y+this.height>=s)return i
return-1},drawEmpty:function(t){var i=TileController._imageController
void 0==i.DrawLevel?(this.context.beginPath(),this.context.fillStyle="#D7DDDD",this.context.fillRect(this._locations[t].x+4,this._locations[t].y+4,this.width-8,this.height-8),this.context.rect(this._locations[t].x+4,this._locations[t].y+4,this.width-8,this.height-8),this.context.lineWidth=1,this.context.strokeStyle="white",this.context.stroke()):i.DrawLevel(this.item,this.context,this._locations[t].x+4,this._locations[t].y+4,this.width-8,this.height-8)},now:null,end:null,width:0,height:0,origwidth:0,origheight:0,ratio:1,startwidth:0,startheight:0,destinationwidth:0,destinationheight:0,destinationVisible:!0,context:null,item:null,firstFilterItemDone:!1,selectedLoc:0,setSelected:function(t){this._selected=t}}),PivotViewer.Views.TileLocation=Object.subClass({init:function(){},x:0,y:0,startx:0,starty:0,destinationx:0,destinationy:0})
=======
